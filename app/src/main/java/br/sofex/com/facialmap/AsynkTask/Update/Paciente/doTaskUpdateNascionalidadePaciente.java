...
public class doTaskUpdateNascionalidadePaciente  extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateNascionalidadePaciente(Context context,String NewValue, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateNacionalidadeByCod(NewValue,this.CodPaciente);
        return null;
    }
