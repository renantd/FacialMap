...
public class doTaskUpdateFotoByCod extends AsyncTask<String, Void, Void> {
    private AlertDialog alerta;
    private Context mContext;
    private Long CodPaciente;
    private byte[] NewFoto;


    public doTaskUpdateFotoByCod(Context context, byte[] NewFoto, Long CodPaciente) {
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateFotoPacByCod(NewFoto,this.CodPaciente);
        return null;
    }
