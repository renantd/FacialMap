...
public class doTaskCarregarPaciente  extends AsyncTask<Void,Void, String> {
    ...
    public doTaskCarregarPaciente(Context context,String NomePaciente){
        mContext = context;
    ...
    protected String doInBackground(Void... voids) {
        ...
        editor.putString("PacienteSelecionado", NomePaciente);
        editor.commit();
        return sharedPreferences.getString("PacienteSelecionado",null);
    }
