...
public class doTaskUpdateFixoPaciente extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateFixoPaciente(Context context,String NewValue, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateFixoByCod(NewValue,this.CodPaciente);
        return null;
    }
