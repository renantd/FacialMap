...
public class doTaskPacGetCodByNome  extends AsyncTask<String, Void, Long> {
    ...
    public doTaskPacGetCodByNome(Context context, String NomePaciente){
      mContext = context;
    ...
    protected Long doInBackground(String... params) {
        return FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetCodPacienteByNome(this.NomePaciente);
    }
