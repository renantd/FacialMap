...
public class doTaskUpdateDataNascimentoPaciente  extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateDataNascimentoPaciente(Context context,String NewValue, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateDTNascByCod(NewValue,this.CodPaciente);
        return null;
    }
