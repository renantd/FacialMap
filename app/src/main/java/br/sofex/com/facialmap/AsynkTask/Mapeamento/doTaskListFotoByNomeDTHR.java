...
public class doTaskListFotoByNomeDTHR extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskListFotoByNomeDTHR(Context context, String NomePaciente, String DataCriacao, String HoraCriacao){
        mContext = context;
    ...
    protected List<String> doInBackground(String... params) {
      ...
      String Nome   =                FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetPontoByNomeDTHR (this.NomePaciente,this.DataCriacao,this.HoraCriacao);
      String CoordX = String.valueOf(FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetCoordXByNomeDTHR(this.NomePaciente,this.DataCriacao,this.HoraCriacao));
      String CoordY = String.valueOf(FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetCoordYByNomeDTHR(this.NomePaciente,this.DataCriacao,this.HoraCriacao));

      List1.add(Nome+"X"+CoordX+" P"+Nome.replace("P","")+"Y"+CoordY);
      return List1;
    }
