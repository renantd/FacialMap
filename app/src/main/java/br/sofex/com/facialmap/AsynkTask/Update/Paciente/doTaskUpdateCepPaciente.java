...
public class doTaskUpdateCepPaciente  extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateCepPaciente(Context context,String Cep,String Endereco,String Complemento,String Numero,
                                   String Bairro,String Municipio,String Estado,Long CodPaciente) {
        mContext =          context;
    ...
    protected Void doInBackground(String... strings) {
        ...
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateCepByCod(Cep,Endereco,Complemento,Numero,Bairro,Municipio,Estado,this.CodPaciente);
        return null;
    }
