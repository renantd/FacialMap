...
public class doTaskCadastroGetFotoByCod  extends AsyncTask<String, Void, byte[]> {
    ...
    public doTaskCadastroGetFotoByCod(Context context,Long CodPaciente){
        mContext = context;
    ...
    protected byte[] doInBackground(String... params) {
      return  FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetFotoPacienteByCod(this.CodPaciente);
    }
