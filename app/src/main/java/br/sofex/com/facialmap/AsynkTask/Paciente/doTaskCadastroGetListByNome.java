...
public class doTaskCadastroGetListByNome   extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskCadastroGetListByNome(Context context,String Nome,Integer Option){
        mContext = context;
        this.Option = Option;
        this.Nome = Nome;
    }
    ...
    protected List<String> doInBackground(String... params) {
        ...
        switch(Option){
            case 1:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetNomePacienteListByNome(this.Nome);
                break;
            }
            case 2:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetDocumentoListByNome(this.Nome);
                break;
            }
            case 3:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetDocumentoConteudoByNome(this.Nome);
                break;
            }
            case 4:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetNacionalidadeListByNome(this.Nome);
                break;
            }
            case 5:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetDataNascListByNome(this.Nome);
                break;
            }
            case 6:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetTelFixoListByNome(this.Nome);
                break;
            }
            case 7:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetTelCelularListByNome(this.Nome);
                break;
            }
            case 8:
            {
                ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetEmailListByNome(this.Nome);
                break;
            }
        }
