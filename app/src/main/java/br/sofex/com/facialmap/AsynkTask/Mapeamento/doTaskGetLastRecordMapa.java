...
public class doTaskGetLastRecordMapa  extends AsyncTask<String, Void, Long> {
    ...
    public doTaskGetLastRecordMapa(Context context){this.mContext = context;}
    ...
    protected Long doInBackground(String... params) {
      return FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetLastRecordMapa();
    }
