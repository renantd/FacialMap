...
public class doTaskGetPacListDataByCods extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskGetPacListDataByCods(Context context, Long CodPaciente, Integer Option){
        mContext = context;
    ...
    protected List<String> doInBackground(String... params) {
        ...
        switch(Option){
            case 1:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetListDataMapasByCods(this.CodPaciente);
                break;
            }
            case 2:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetListHoraMapasByCods(this.CodPaciente);
                break;
            }
