...
public class doTaskGetListDataHoraByNP  extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskGetListDataHoraByNP(Context context, Integer Option){
        mContext = context;
        this.Option = Option;
    ...
    protected List<String> doInBackground(String... params) {
        ...
        switch(Option){
            case 1:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetListDataCriacao();
                break;
            }
            case 2:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetListHoraCriacao();
                break;
            }
