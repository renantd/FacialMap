...
public class doTaskListNP_BYDCHC_CMFK extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskListNP_BYDCHC_CMFK(Context context, String NomePaciente, String DataCriacao,
           String HoraCriacao, Long CodMapaFK){
    ...
    protected List<String> doInBackground(String... params) {
        return  FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetListNomePonto_DTHR_NPCMFK(this.NomePaciente,this.DataCriacao,this.HoraCriacao,this.CodMapaFK);
    }
