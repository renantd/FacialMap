...
public class doTaskCadastroGetCodListByCod extends AsyncTask<String, Void, List<Long>> {
    ...
    public doTaskCadastroGetCodListByCod(Context context,Long CodPaciente){
        mContext = context;
    ...
    protected List<Long> doInBackground(String... params) {
        ...
        ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetCodPacienteListByCod(this.CodPaciente);
        return  ListResult;
    }

    @Override
    protected void onPostExecute(List<Long> result) { alerta.dismiss();}
