...
public class doTaskGetListNomePacDTHR   extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskGetListNomePacDTHR(Context context, String NomePaciente, String DataCriacao, String HoraCriacao, Integer Option){
        mContext           = context;
    ...
    protected List<String> doInBackground(String... params) {
      return  FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetListNomePontoDTHR(this.NomePaciente,this.DataCriacao,this.HoraCriacao);
    }
