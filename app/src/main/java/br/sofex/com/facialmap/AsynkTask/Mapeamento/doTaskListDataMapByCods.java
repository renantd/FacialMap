...
public class doTaskListDataMapByCods extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskListDataMapByCods(Context context, Long CodPaciente){
        mContext = context;
    ...
    protected List<String> doInBackground(String... params) {
        return FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetListDataMapasByCods(CodPaciente);
    }
