...
public class doTaskUpdateCelularPaciente  extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateCelularPaciente(Context context,String NewValue, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateCelularByCod(NewValue,this.CodPaciente);
        return null;
    }
