...
public class doTaskGetCodMapaFK_ByNPDCHC  extends AsyncTask<String, Void, Long> {
    ...
    public doTaskGetCodMapaFK_ByNPDCHC(Context context, String NomePaciente, String DataCriacao,
           String HoraCriacao){
    ...
    protected Long doInBackground(String... params) {
        return  FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetListCodMapaFK_DTHR_NPCMFK(this.NomePaciente,this.DataCriacao,this.HoraCriacao);
    }

    @Override
    protected void onPostExecute(Long result) { alerta.dismiss();}
