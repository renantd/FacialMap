...
public class doTaskGetListPaciente  extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskGetListPaciente(Context context,Integer Option){
        mContext = context;
        this.Option =  Option;
    }
    ...
    protected List<String> doInBackground(String... params) {
        ...
        switch(Option){
            case 1:
            {
                List1 = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetListNomePacienteByNome();
                break;
            }
