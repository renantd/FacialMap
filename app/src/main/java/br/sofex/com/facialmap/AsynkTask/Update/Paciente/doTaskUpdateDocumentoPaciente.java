...
public class doTaskUpdateDocumentoPaciente  extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateDocumentoPaciente(Context context, String DocumentoTipo, String DocumentoValor, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateDocumentoByCod(DocumentoTipo,this.CodPaciente);
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateDocConteudoByCod(DocumentoValor,this.CodPaciente);
        return null;
    }
