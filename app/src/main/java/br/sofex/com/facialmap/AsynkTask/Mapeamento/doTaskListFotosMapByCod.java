...
public class  doTaskListFotosMapByCod extends AsyncTask<String, Void, byte[]> {
    ...
    public doTaskListFotosMapByCod(Context context,Long CodPaciente,Integer Option, String DataCriacao, String HoraCriacao){
        mContext = context;
    ...
    protected byte[] doInBackground(String... params) {
        ...
        switch(Option){
            case 1:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetFotoMapaInicialByNome(this.CodPaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
            case 2:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetFotoMapeadaByNome(this.CodPaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
            case 3:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetFotoFinalByNome(this.CodPaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
            case 4:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetFotoVerticalByNome(this.CodPaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
            case 5:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().GetFotoHorizontalByNome(this.CodPaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
    ...
    @Override
    protected void onPostExecute(byte[] result) { alerta.dismiss();}
