...
public class doTaskGetCodMapaFK_ByDCHC   extends AsyncTask<String, Void, Long> {
    ...
    public doTaskGetCodMapaFK_ByDCHC(Context context, String NomePaciente, String DataCriacao,
                                     String HoraCriacao) {
    ...
    protected Long doInBackground(String... params) {
        return FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetCodMapaFK_ByDCHC(this.NomePaciente, this.DataCriacao, this.HoraCriacao);
    }
