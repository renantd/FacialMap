...
public class doTaskUpdateEmailPaciente extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateEmailPaciente(Context context,String NewValue, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateEmailByCod(NewValue,this.CodPaciente);
        return null;
    }
