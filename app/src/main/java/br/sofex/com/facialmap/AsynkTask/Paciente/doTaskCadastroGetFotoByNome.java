...
public class doTaskCadastroGetFotoByNome  extends AsyncTask<String, Void, byte[]> {
    ...
    public doTaskCadastroGetFotoByNome(Context context,String NomePaciente){
        mContext = context;
    ...
    protected byte[] doInBackground(String... params) {
        //byte[] b1  = null;
        return FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetFotoPacienteByNome(this.NomePaciente);
    }
