...
public class doTaskUpdateEtiniaPaciente  extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateEtiniaPaciente(Context context,String NewValue, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateEtniaByCod(NewValue,this.CodPaciente);
        return null;
    }
