...
public class doTaskCadastroGetListFotoByCod extends AsyncTask<String, Void, List<byte[]>> {
    ...
    public doTaskCadastroGetListFotoByCod(Context context,Long CodPaciente,Integer Option){
        mContext = context;
        this.Option =  Option;
    ...
    protected List<byte[]> doInBackground(String... params) {
        ...
        ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetFotoPacienteListByCod(this.CodPaciente);
        return  ListResult;
    }

    @Override
    protected void onPostExecute(List<byte[]> result) { alerta.dismiss();}
