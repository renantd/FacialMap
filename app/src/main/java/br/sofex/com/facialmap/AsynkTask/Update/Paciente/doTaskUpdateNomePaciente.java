...
public class doTaskUpdateNomePaciente extends AsyncTask<String, Void, Void> {
    ...
    public doTaskUpdateNomePaciente(Context context,String Nome, Long CodPaciente){
        mContext = context;
        this.Nome = Nome;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().UpdateNomeByCod(Nome,this.CodPaciente);
        return null;
    }
