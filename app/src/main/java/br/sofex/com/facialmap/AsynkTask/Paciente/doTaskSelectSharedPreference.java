...
public class doTaskSelectSharedPreference  extends AsyncTask<String, Void, String> {
    ...
    public doTaskSelectSharedPreference(Context context,Long CodUsuario,String NomePaciente){
        mContext = context;
    ...
    protected String doInBackground(String... params) {
        ...
        String Str = "";
        Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetNomePacByCodNome(this.CodUsuario,this.NomePaciente);
        return  Str;
    }
