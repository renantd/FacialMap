...
public class DoTaskDeletePacienteByCod extends AsyncTask<String, Void, Void> {

    private AlertDialog alerta;
    private Context mContext;
    private Long CodPaciente;

    public DoTaskDeletePacienteByCod(Context context, Long CodPaciente){
        mContext = context;
    ...
    protected Void doInBackground(String... strings) {
        FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().DeletePacienteByCod(this.CodPaciente);
        return null;
    }
