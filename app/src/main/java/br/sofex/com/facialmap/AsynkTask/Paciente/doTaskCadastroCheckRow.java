...
public class doTaskCadastroCheckRow extends AsyncTask<String, Void, List<String>> {
    ...
    public doTaskCadastroCheckRow(Context context,Integer Option){
    ...
    protected List<String> doInBackground(String... params) {
        ...
        List<String> ListResul = new ArrayList<>();

        if(this.Option == 1){

            ListResul = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetDocumentoConteudo();

        }else if (this.Option == 2){

            ListResul = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetNomePacienteList();

        }
        else if (this.Option == 3){

            ListResul = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetFotoNomePacienteList();
