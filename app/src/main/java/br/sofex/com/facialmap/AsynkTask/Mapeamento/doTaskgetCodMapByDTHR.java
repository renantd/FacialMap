...
public class doTaskgetCodMapByDTHR extends AsyncTask<String, Void, Long> {
    ...
    public doTaskgetCodMapByDTHR(Context context, String NomePaciente, String DataCriacao, String HoraCriacao){
        mContext = context;
    ...
    protected Long doInBackground(String... params) {
      return  FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetCodMapaByDTHR(this.NomePaciente,this.DataCriacao,this.HoraCriacao);
    }
