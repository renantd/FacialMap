...
public class doTaskCadastroGetCodList   extends AsyncTask<String, Void, List<Long>> {
    ...
    public doTaskCadastroGetCodList(Context context) {mContext = context;}
    ...
    protected List<Long> doInBackground(String... params) {
        List<Long> ListResul;
        ListResul = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetCodPacienteList();
        return ListResul;
    }
