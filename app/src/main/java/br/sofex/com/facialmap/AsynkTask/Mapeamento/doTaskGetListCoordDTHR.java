...
public class doTaskGetListCoordDTHR  extends AsyncTask<String, Void, List<Integer>> {
    ...
    public doTaskGetListCoordDTHR(Context context, String NomePaciente, String DataCriacao, String HoraCriacao, Integer Option){
        mContext = context;
    ...
    protected List<Integer> doInBackground(String... params) {
        ...
        switch(Option){
            case 1:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetListCoordXDTHR(this.NomePaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
            case 2:
            {
                Str = FacialMapRoomDatabase.getDatabaseMapa(mContext).pontoDao().GetListCoordYDTHR(this.NomePaciente,this.DataCriacao,this.HoraCriacao);
                break;
            }
    ...
    @Override
    protected void onPostExecute(List<Integer> result) { alerta.dismiss();}
