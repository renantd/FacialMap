...
public class doTaskCadastroGetCodListByNome extends AsyncTask<String, Void, List<Long>> {
    private AlertDialog alerta;
    private Context mContext;
    private String Nome;


    public doTaskCadastroGetCodListByNome(Context context,String Nome){
        mContext = context;
        this.Nome = Nome;
    }
    ...
    protected List<Long> doInBackground(String... params) {
        ...
        ListResult = FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().GetCodPacienteListByNome(this.Nome);
        return  ListResult;
    }
