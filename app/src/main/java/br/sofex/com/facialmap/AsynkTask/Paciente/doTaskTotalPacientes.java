...
public class doTaskTotalPacientes  extends AsyncTask<String, Void, Integer> {
    ...
    public doTaskTotalPacientes(Context context){ mContext = context;}
    ...
    protected Integer doInBackground(String... params) {
        return  FacialMapRoomDatabase.getDatabaseMapa(mContext).pacienteDao().TotalPacientes();
    }

    @Override
    protected void onPostExecute(Integer result) { alerta.dismiss();}
