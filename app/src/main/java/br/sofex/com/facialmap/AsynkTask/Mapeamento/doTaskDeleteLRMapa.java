...
public class doTaskDeleteLRMapa extends AsyncTask<String, Void, Void> {
    ...
    public doTaskDeleteLRMapa(Context context,Long CodMapa){this.mContext = context; this.CodMapa = CodMapa;}
    ...
    protected Void doInBackground(String... params) {
      ...
      FacialMapRoomDatabase.getDatabaseMapa(mContext).mapaDao().DeleteLastRecordMapa(this.CodMapa);
      return null;
    }
